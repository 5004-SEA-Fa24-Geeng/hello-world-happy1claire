...
public class Greeting extends Object {
    ...
    /**
     * Greeting that creates a greeting with ascii and unicode characters assuming the language is already using ascii
     * letters only. It also assumes the format of the greeting to be "{greeting}, {name}!"
     * For the default format string you will want to use "%s, %%s!"
     * which places the greeting before the persons potential name.
     * @param localityID  id of the locality
     * @param localityName name of the locality
